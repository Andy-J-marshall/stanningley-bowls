...
export class TeamTabsPage {
  ...
  constructor(page: Page) {
    ...
    this.wedPairsTeamStats = page.locator('#team-stats #team-stat-tab-wednesday-pairs');
    this.wedPairsTeamRecords = page.locator('#player-records #player-record-tab-wednesday-pairs');
  }
