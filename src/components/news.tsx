    ...
    return (
        <div id="news">
            ...
            >
                <NewsItem
                    title="AGM DATE"
                    text="The 2024 AGM will be at 11am on the 9th November at Stanningley Park Bowling Club. If you have any proposals then contact a member of the committee before the 6th November."
                    imgSrc={agmImage}
                />
                <NewsItem
